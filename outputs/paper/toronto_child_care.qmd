...
A variable which may skew the data or produce outliers is the fact that each of Toronto's wards contain multiple neighborhoods with various social and economic considerations [@wards]. Outliers such as Toronto Centre and Scarborough Rouge-Park may be influenced by variation in income by neighborhood or higher child care supply based on commuting population and business density. Although average household income by ward was used in @fig-childrenspacesplot and @fig-childrenspacesscatterplot, an analysis using the median household income of each ward yielded a similar trend (see Apendix: @fig-spacesmedianbywards & @fig-spacesmedianincome). 

To obtain a more accurate and holistic view of child care access in Toronto, an analysis of neighborhood population and income in relation to child care facilities may be beneficial if this data becomes available. An important finding of this paper is that on average, there are 5.1 children in Toronto for every space at a licensed child care facility indicating a shortage throughout the city. Both inequitable access to and general lack in supply of licensed quality child care spaces may be influenced by the market-model child care system [@friendly]. This type of child care system means that non profit and commercial facilities out number publicly operated facilities as is reflected in @sec-childcare. Non profit and commercial providers operate privately and therefore have different operational strategies and objectives when compared to publicly operated facilities [@friendly]. Measures to increase both the number of child care spaces and equitable access are therefore important and essential public policy initiatives [@strategy].
